        ...
        <div class="box-body">
                ...
                <div class="col-md-6">
		             <form   action="{{ url('agregar_permiso') }}"  method="post" id="f_asignar_permiso" class="formentrada"  >
						...
						<div class="form-group">
							<label class="col-sm-2" for="rol">Papel*</label>
		    			<div class="col-sm-10" >
						...
						<div class="form-group">
							<label class="col-sm-2" for="rol">Permissão*</label>
		    			<div class="col-sm-10" >
			    ...
			    <div class="col-md-6">
		            ...
		            <form   action="{{ url('criar_permiso') }}"  method="post" id="f_crear_permiso" class="formentrada"  >
		                ...
		                <div class="col-md-12">	  
			                <div class="form-group">
									<label class="col-sm-2" for="apellido">Permissão*</label>
			                    <div class="col-sm-10" >
    ...
    <div class="table-responsive" >
	    ...
	    @foreach($rol->permissions as $permiso)
		 ...
		 <tr role="row" class="odd" id="filaP_{{ $permiso->id }}">
			...
			<td>
			<a href="{!! url('/form_editar_permiso/'.$permiso->id) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
			<a href="{!! url('apagar_permiso/'.$rol->id.'/'.$permiso->id) !!}" class='btn btn-danger btn-xs'><i class="glyphicon glyphicon-trash">
			</td>
		   </tr>
